...
async def ask_ishushka(
    ...
    system_prompt = (
        ...
        "2. **Предмет запроса:**\n"
        "   - **ASIC/Майнинг:** При упоминании конкретной модели или расчетов доходности, после основного ответа ОБЯЗАТЕЛЬНО добавь фразу: 'Для проверки текущей доступности и актуальных условий покупки [название модели], пожалуйста, уточните у менеджера или посмотрите в нашем канале. Менеджер - @vadim_0350 канал - @asic_plus'\n"
